...
mongoose.connect(process.env.MONGODB_URI || "mongodb://localhost/thrones");
...
const quizSeed = [
  ...
  },
  {
    ...
    a: ["Petyr Baelish", "Olenna Tyrell", "Dontos", "Tyrion Lannister"],
  ...
  },
  {
    ...
    footnote: "\"Winter is coming.\" - Words of House Stark"
  }
]

db.Question.remove({})
  .then(() => db.Question.collection.insertMany(quizSeed))
  .then(data => {
